...
async function init() {
  ...
  function generate(){
    ...
    if (implHelp && implHelp!=="None"){
      let remoteSku = "";
      // Windows PC based OR USB bar only -> PROECOSYS02
      if (typeOfSystem==="Windows PC based solution" || typeOfSystem==="USB bar only") remoteSku = "PROECOSYS02";
...
// Mounting logic (real SKUs)
    (function addMounting(){
      ...
      const isX52 = hasSku(results,"8D8K2AA#ABA") || hasSku(results,"8D8L1AA#ABA");
...
<p class="text-sm mb-2"><a class="text-blue-600 underline" target="_blank" href="https://drive.google.com/file/d/1F3781t_EBTEdLournarER9XfmkGG9CRi/view?usp=sharing">Quoting Guide</a>&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;<a class="text-blue-600 underline" target="_blank" href="https://www.hp.com/us-en/poly/spaces.html">Poly Spaces</a></p>
