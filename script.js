...
document.title = 'Poly Video Conferencing "Bill" of Materials Generator v9.23';
...
function generate(catalog) {
  ...
  if (typeOfSystem === "Windows PC based solution") {
    ...
    if (platform !== "Google Meet") {
      if (platform === "Zoom") {
        const zoomPcSku = "9C422AW#ABA";
        addLine(results, zoomPcSku, "HP Mini Conf G9 wZR i7-12700T 16GB Zoom Room PC only (must add TC10, Camera, Audio)");
        const zoomPcSupport = (supportTerm === "3yr") ? "P88120312" : "P88120112";
        if (supportTerm !== "None") addLine(results, zoomPcSupport);
        // Add TC10 and its support
