...
async function init() {
  ...
  document.getElementById("roomSize").addEventListener("change", ()=>{updateCameraVisibility();updateExpansionMicUI();updateRoomSizeHint();});
  document.getElementById("expansionMic").addEventListener("change", updateExpansionMicUI);
  updatePlatformInfo(); updateCameraVisibility(); updateExpansionMicUI(); updateRoomSizeHint();
  ...
  function generate(){
    ...
    // Expansion mic logic
    if ((roomSize==="Medium" || roomSize==="Large") && expansionMic==="Single Analog Exp mic" && !hasSku(results,"875M6AA")) {
...
<p class="text-sm italic text-gray-600 mb-2">Disclaimer:
<p class="text-sm mb-2"><a class="text-blue-600 underline" target="_blank" href="B5NH6AA">Quoting Guide</a>&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;<a class="text-blue-600 underline" target="_blank" href="https://www.hp.com/us-en/poly/spaces.html">Poly Spaces</a></p>
<p class="text-sm mb-4"><a class="text-blue-600 underline" target="_blank" href="https://docs.google.com/spreadsheets/d/1cQMLvJeQ9WFBrL7Fkw8vY1FWJUuTj7e5/edit?usp=sharing&ouid=104449332556651601678&rtpof=true&sd=true">Glen Bevcar's Collab Reference Excel cheat sheet</a>&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;<a class="text-blue-600 underline" target="_blank" href="https://h30434.www3.hp.com/t5/Meeting-Room-Solutions/Dimensional-Drawings-for-Poly-Products-and-accessories/td-p/8738366">Dimensional Drawings for Poly Products</a></p>
